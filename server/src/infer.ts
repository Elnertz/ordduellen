...
const RULES: Rule[] = [
  ...
  { match: ['byggnad', 'hus', 'torn', 'slott', 'borg', 'skyskrapa'], tags: ['building'] },
  { match: ['stad', 'metropol', 'huvudstad'], tags: ['city', 'building'] },
  { match: ['riddare', 'krigare', 'gladiator'], tags: ['soldier', 'human', 'blade'] },
